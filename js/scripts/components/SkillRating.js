...
export default class SkillRating extends BaseComponent {
  constructor(options) {
    ...
    this.options.fillColor =
      "fillColor" in options
        ? options.fillColor
        : this.defaultOptions.fillColor;
    this.options.color =
      "color" in options ? options.color : this.defaultOptions.color;
    this.options.total =
      "total" in options ? options.total : this.defaultOptions.total;
    this.options.fill =
      "fill" in options ? options.fill : this.defaultOptions.fill;
    this.options.label =
      "label" in options ? options.label : this.defaultOptions.label;
