...
export default class Icon extends BaseComponent {
  constructor(options) {
    ...
    this.options.textAlignment =
      "textAlignment" in options
        ? options.textAlignment
        : this.defaultOptions.textAlignment;
    this.options.imgSize =
      "imgSize" in options ? options.imgSize : this.defaultOptions.imgSize;
    this.options.fontSize =
      "fontSize" in options ? options.fontSize : this.defaultOptions.fontSize;
    this.options.fontWeight =
      "fontWeight" in options
        ? options.fontWeight
