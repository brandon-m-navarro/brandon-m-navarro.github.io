...
class Particle {
  constructor(options) {
    ...
    this.x = "x" in options ? options.x : this.defaultOptions.x;
    this.y = "y" in options ? options.y : this.defaultOptions.y;
    this.vx = "vx" in options ? options.vx : this.defaultOptions.vx;
    this.vy = "vy" in options ? options.vy : this.defaultOptions.vy;
    this.radius =
      "radius" in options ? options.radius : this.defaultOptions.radius;
  }
...
class ShootingStar extends Particle {
  constructor(options) {
    ...
    // Initialize parameters
    this.opacity =
      "opacity" in options ? options.opacity : defaultOptions.opacity;
    this.trailLengthDelta =
      "trailLengthDelta" in options
        ? options.trailLengthDelta
        : defaultOptions.trailLengthDelta;
    this.isSpawning =
      "isSpawning" in options ? options.isSpawning : defaultOptions.isSpawning;
    this.isDying =
      "isDying" in options ? options.isDying : defaultOptions.isDying;
    this.isDead = "isDead" in options ? options.isDead : defaultOptions.isDead;
  }
}
...
export default class NightSky extends BaseComponent {
  constructor(options) {
    ...
    // Initialize parameters
    this.bg = "bg" in options ? options.bg : defaultOptions.bg;
